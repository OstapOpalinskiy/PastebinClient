...
public class MainFragmentPresenter implements IMainScreen.IPresenterFragment {
    private IMainScreen.IViewFragment view;
    ...
    public MainFragmentPresenter(IMainScreen.IViewFragment view) {
        this.view = view;
